...
namespace Suma_chetni_nechetni
{
    class EvenOddMultiplication
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Sumata ot chetnite e:"+s);
           int sn= GetSumOfOddDigits(chislo2);
            Console.WriteLine("Sumata ot nechetnite e"+sn);
            Console.WriteLine("Proizvedenieto e:"+ GetMultipleOfEvensAndOdds(s,sn));
